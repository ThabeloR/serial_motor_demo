...
{
  new (message_memory) serial_motor_demo_msgs::msg::SteeringCommand(_init);
}

void SteeringCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<serial_motor_demo_msgs::msg::SteeringCommand *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SteeringCommand_message_member_array[2] = {
  {
    ...
    offsetof(serial_motor_demo_msgs::msg::SteeringCommand, steering_angle),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(serial_motor_demo_msgs::msg::SteeringCommand, turning_radius),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SteeringCommand_message_members = {
  ...
  2,  // number of fields
  sizeof(serial_motor_demo_msgs::msg::SteeringCommand),
...
get_message_type_support_handle<serial_motor_demo_msgs::msg::SteeringCommand>()
{
  return &::serial_motor_demo_msgs::msg::rosidl_typesupport_introspection_cpp::SteeringCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, serial_motor_demo_msgs, msg, SteeringCommand)() {
  return &::serial_motor_demo_msgs::msg::rosidl_typesupport_introspection_cpp::SteeringCommand_message_type_support_handle;
}
